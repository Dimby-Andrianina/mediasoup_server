...
io.on('connection', (socket) => {
  ...
  socket.on('join', async ({ room_id, name }) => {
    ...
    // console.log(roomList.get(room_id).toJson())
  })
  ...
  socket.on('connectTransport', async ({ transport_id, dtlsParameters }) => {
